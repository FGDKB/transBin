...
parser.add_argument('transBinpath', help='Path to transBin directory')
...
sys.path.append(args.transBinpath)
import transBin
import os
...
binning = transBin.benchmark.Binning(clusters, reference, minsize=args.min_bin_size, disjoint=args.disjoint,
